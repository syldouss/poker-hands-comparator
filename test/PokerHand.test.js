...
describe('test compareWith function', () => {
  ...
  it('case Royal Flush', () => {
    let hand1 = new PokerHand('QS JS TS AS KS')
    let hand2 = new PokerHand('TH JH AH QH KH')
    expect(hand1.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Straight Flush', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('3H 5H 6H 4H 7H')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Four of Kind', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS AC 5S AD AH')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Full House', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS AC KS KD AH')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Flush', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('TH JH 6H 4H 7H')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Straight', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('TH JH AH QS KC')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Three of Kind', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS AC 5S 4D AH')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Two Pairs', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS AC 5S 4D 4H')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. Pair', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS AC 5S 4D KH')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
  it('case Royal Flush vs. High Card', () => {
    let hand1 = new PokerHand('TH JH AH QH KH')
    let hand2 = new PokerHand('AS QC 5S 4D KH')
    expect(hand1.compareWith(hand2)).to.equal(1)
    expect(hand2.compareWith(hand1)).to.equal(2)
    expect(hand2.compareWith(hand2)).to.equal(3)
  })
